...
public class BlogPostDAO {
   ...
   // White space to protect the innocent
    ...
    public void addPostComment(final String name, final String email, final String body,
    	...
    	try {
    		BasicDBObject blogPost = (BasicDBObject) postsCollection.findOne(new BasicDBObject("permalink", permalink));

    		@SuppressWarnings("unchecked")
			ArrayList<BasicDBObject> commentsArr = (ArrayList<BasicDBObject>) blogPost.get("comments");
	        ...
	        postsCollection.update(new BasicDBObject("permalink", permalink), new BasicDBObject("$set", new BasicDBObject("comments", commentsArr)));
        }
        catch (Exception e) {
        	e.printStackTrace();
        }
